...
### 7.7 Kategori 7: Pemeran Pendatang Baru Pria Terfavorit (8 Nominees)
1. El Putra - Rangga & Cinta (`assets/actor_el_putra.webp`)
2. King Aloy - Comic 8 Revolutions (`assets/actor_king_aloy.jpg`)
3. Coach Justin - Jangan Seperti Bapak (`assets/actor_justin.webp`)
4. Magistus Miftah - Ghost in The Cell (`assets/actor_magistus.webp`)
5. Alim Marwan - Semua Akan Baik-Baik Saja (`assets/actor_alim.webp`)
6. Ade Ray - Semua Akan Baik-Baik Saja (`assets/actor_ade_ray.webp`)
7. Kev Luqman - Monster Pabrik Rambut (`assets/actor_kev.webp`)
8. Arkenzy Taulany - Kang Solah (`assets/actor_kenzi.webp`)

### 7.8 Kategori 8: Pemeran Pendatang Baru Wanita Terfavorit (8 Nominees)
1. Melati Sesilia - Nobody Loves Kay (`assets/actor_melati_sesilia.webp`)
2. Elsa Japassal - Sekawan Limo 2 (`assets/actor_elsa_japassal.webp`)
3. Anggun C. Sasmi - Para Perasuk (`assets/actor_anggun.webp`)
4. Leya Princy - Rangga & Cinta (`assets/actor_leya_princy.webp`)
5. Alika Jantinia - Pencarian Terakhir (`assets/actor_alika_jantinia.webp`)
6. Dilan Janiyar - Sosok Ketiga: Lintrik (`assets/actor_dilan_janiyar.webp`)
7. Livi Ciananta - Ikatan Darah (`assets/actor_livi_ciananta.webp`)
8. Messi Gusti - Pelangi di Mars (`assets/actor_messi_gusti.webp`)
